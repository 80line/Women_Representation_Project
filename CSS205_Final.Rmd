...
## Model with all Predictors in Table 5 Additively

```{r}
add_glm <- glm(GeWom ~ FemSig_Bin + FemNeg_Bin + FemMed_Bin + FemOb_Bin, 
               data = df, 
               family = 'binomial')
```
...
```{r, warning = F}
stargazer(add_glm, type="text",
          covariate.labels = c("Women Signatories", "Women Negotiators", "Women Mediators", "Women Observers"),
          dep.var.caption = "Women Delegates per Negotiation (Binary)",
          dep.var.labels = "Provisions for Women")
```

## Out of Curiosity Model
...
big_glm <- glm(GeWom ~ FemSig_Bin + FemNeg_Bin + FemMed_Bin + FemOb_Bin + year, 
               data = df, 
               family = 'binomial')

stargazer(big_glm, type="text")
```

## Just Year Model

```{r, warning = F}
year_glm <- glm(GeWom ~ year, 
               data = df, 
               family = 'binomial')
...
```{r, warning = F}
stargazer(sig_b_glm, add_glm, type="text",
          covariate.labels = c("Women Signatories", "Women Negotiators", "Women Mediators", "Women Observers"),
          dep.var.caption = "Women Delegates per Negotiation (Binary)",
          dep.var.labels = "Provisions for Women")
```
...
```{r}
AIC(sig_b_glm, add_glm, big_glm, year_glm)
BIC(sig_b_glm, add_glm, big_glm, year_glm)
```
