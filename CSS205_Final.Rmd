...
plot1 <- ggplot(sig_pred, aes(x = as.factor(FemSig_Bin), y = GeWom_Prob)) +
  ...
  labs(title = "Effect of Women Signatories on Provisions for Women",
       x = "Women Signatories (0 = No, 1 = Yes)",
...
plot2 <- ggplot(df_new, aes(x = year, y = predicted_prob)) +
  ...
  geom_ribbon(aes(ymin = Lower, ymax = Upper), 
              alpha = 0.2, fill = "palevioletred2") +
  labs(title = "Effect of Year on Provisions for Women",
       x = "Year",
       y = "Predicted Probability of Provisions for Women") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5),
